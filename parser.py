...
def parse_tree_to_ast(e):
    ...
    # terms
        ...
        return Var(e.meta, parse_tree_to_ast(e.children[0]))
    ...
    if e.data == 'proof_var':
       ...
       return PAndElim(e.meta, int(e.children[0].value), subject)
        ...
        pat = parse_tree_to_ast(e.children[0])
        assms = parse_tree_to_list(e.children[1])
        body = parse_tree_to_ast(e.children[2])
        ...
        body = parse_tree_to_ast(e.children[1])
        return ApplyDefsGoal(e.meta, [Var(e.meta, t) for t in definitions], body)
    ...
    # patterns in function definitions
        ...
        params = parse_tree_to_list(e.children[1])
