...
3. Work backwards from the goal using a [`suffices`](./Reference.md#suffices-proof-statement) statement. After the `by` keyword, write the reason, often [`expand`](./Reference.md#expand-proof) and/or [`replace`](./Reference.md#replace-proof), which transform the goal formula.
