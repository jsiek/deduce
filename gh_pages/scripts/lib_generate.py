...
from keywords import get_known_tokens
...
def generate_html(html_file, known_tokens, lib_pf_files, lib_thm_files, program_text, tokens, unions, functions, theorems, constructors):
...
if __name__ == '__main__':
    ...
    for f in lib_pf_files + lib_thm_files:
        ...
        generate_html(html_file=os.path.join(lib_html_dir, name + extension + '.html'),
                      known_tokens=get_known_tokens(),
                      lib_pf_files=lib_pf_files,
                      lib_thm_files=lib_thm_files,
