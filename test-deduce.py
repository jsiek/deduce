...
if __name__ == "__main__":
    ...
    if generate_errors:
        ...
        generate_deduce_errors(deduce_call +  ' --dir ' + test_imports_dir, error_dir)
    elif generate_some_errors:
        for generable in regenerables:
            print('Generating error for:', generable)
            generate_deduce_errors(deduce_call +  ' --dir ' + test_imports_dir, generable)
        ...
        test_deduce_errors(deduce_call +  ' --dir ' + test_imports_dir, error_dir)
    else:
