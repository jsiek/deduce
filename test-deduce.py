...
if __name__ == "__main__":
    ...
    if generate_errors:
        ...
        test_deduce(parsers, deduce_call +  f' --dir {test_imports_dir} --dir {lib_dir} ', pass_dir)
    elif test_errors:
        ...
        test_deduce(parsers, deduce_call +  f' --dir {test_imports_dir} --dir {lib_dir} ', [lib_dir, pass_dir])
        test_deduce_errors(deduce_call +  f' --dir {test_imports_dir} --dir {lib_dir} ', error_dir)    
        test_deduce_errors(deduce_call + f' --dir {lib_dir} ', parse_dir)
