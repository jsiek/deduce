...
EXPERIMENTAL_IMPERATIVE_FILES = frozenset({
    ...
    "./test/should-validate/imperative_mutable_array.pf",
    "./test/should-validate/imperative_array_write.pf",
    "./test/should-warn/imperative_array_alias.pf",
    "./test/should-error/imperative_array_write_type.pf",
    "./test/should-error/imperative_array_write_unbounded.pf",
    "./test/should-error/imperative_array_read_unbounded.pf",
